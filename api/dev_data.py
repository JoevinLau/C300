...
SUPPORTED_CALCULATION_YEARS = tuple(sorted(DEV_FX_INFLATION))
MIN_CALCULATION_YEAR = SUPPORTED_CALCULATION_YEARS[0]
MAX_CALCULATION_YEAR = SUPPORTED_CALCULATION_YEARS[-1]
